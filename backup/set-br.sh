...
echo "Checking VPS"
# Link Hosting Kalian
akbarvpn="https://raw.githubusercontent.com/putrapetirr0/scriptku/029942a7c1200813841de42342e4d092fe997359/backup"
...
wget -O backup-telegram "https://${akbarvpn}/backup-telegram.sh"
chmod +x autobackup
chmod +x backup
chmod +x restore
chmod +x strt
